                     ...
                     <div class="form-group row">
                        ...
                        <div class="col-lg-9">
                            ...
                            @if(count($item->addon_categories))
                                <button class="btn btn-sm btn-danger badge badge-danger float-right" data-toggle="modal" data-target="#removeAllAddonConfirmation" type="button" id="removeAllAddons" style="font-size: 0.9rem;">Remove All Addons
                                </button>
                                    ...
                                    <div class="modal-dialog modal-xs">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                <span class="help-text">This action will remove all addons from this item.</span>
