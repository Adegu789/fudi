                    ...
                    <div class="d-lg-flex justify-content-lg-left">
                        <ul class="nav nav-pills flex-column mr-lg-3 wmin-lg-250 mb-lg-0">
                            ...
                            <li class="nav-item">
                                ...
                                SMS Gateway <span class="badge badge-flat border-grey-800 text-danger text-capitalize mr-1" style="float: right;">NEW</span>
                                </a>
                            </li>
                            <li class="nav-item">
                        ...
                        <div class="tab-content" style="width: 100%; padding: 0 25px;">
                            <div class="tab-pane fade show active" id="generalSettings">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-9">
                                        <input type="text" class="form-control form-control-lg" name="walletName"
                                            value="{{ config('settings.walletName') }}" placeholder="Enter the name of your wallet system (Eg: Coins, PiggyBank)">
                                    </div>
                                </div>
                                <div class="form-group row">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-9">
                                        <div class="checkbox checkbox-switchery mt-2">
                                            <label>
                                            <input value="true" type="checkbox" class="switchery-primary" @if(config('settings.enSPU') == "true") checked="checked" @endif name="enSPU">
                                            </label>
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="col-lg-3 col-form-label"><strong>Enable Delivery Pin? </strong></label>
                                    <div class="col-lg-9">
                                        <div class="checkbox checkbox-switchery mt-2">
                                            <label>
                                            <input value="true" type="checkbox" class="switchery-primary" @if(config('settings.enableDeliveryPin') == "true") checked="checked" @endif name="enableDeliveryPin">
                                            </label>
                                        </div>
                                    </div>
                                </div>
                               {{--  <div class="form-group row">
                                    <label class="col-lg-3 col-form-label"><strong>Enable Google API for Restaurant's Location? </strong></label>
                                    <div class="col-lg-9">
                                        <div class="checkbox checkbox-switchery mt-2">
                                            <label>
                                            <input value="true" type="checkbox" class="switchery-primary" @if(config('settings.enableGoogleAPI') == "true") checked="checked" @endif name="enableGoogleAPI">
                                            </label>
                                        </div>
                                    </div>
                                </div> --}}
                                <div class="form-group row">
                                    <label class="col-lg-3 col-form-label"><strong>Max Time for Accept Order: </strong></label>
                                    <div class="col-lg-9">
                                        <input type="text" class="form-control form-control-lg threshold-time" name="restaurantAcceptTimeThreshold"
                                            value="{{ config('settings.restaurantAcceptTimeThreshold') }}">
                                            <span class="help-text text-muted">Maximum time in minutes after which admin gets notification in the orders page that the restaurant owner has not accepted the order.</span>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="col-lg-3 col-form-label"><strong>Max Time for Accept Delivery: </strong></label>
                                    <div class="col-lg-9">
                                        <input type="text" class="form-control form-control-lg threshold-time" name="deliveryAcceptTimeThreshold"
                                            value="{{ config('settings.deliveryAcceptTimeThreshold') }}">
                                            <span class="help-text text-muted">Maximum time in minutes after which admin gets notification in the orders page that the delivery guy has not accepted the order.</span>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="col-lg-3 col-form-label"><strong>Hide Price when Zero? </strong></label>
                                    <div class="col-lg-9">
                                        <div class="checkbox checkbox-switchery mt-2">
                                            <label>
                                            <input value="true" type="checkbox" class="switchery-primary" @if(config('settings.hidePriceWhenZero') == "true") checked="checked" @endif name="hidePriceWhenZero">
                                            </label>
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="col-lg-3 col-form-label"><strong>Default Country Code on Phone field: </strong></label>
                                    <div class="col-lg-9">
                                        <input type="text" class="form-control form-control-lg" name="phoneCountryCode"
                                            value="{{ config('settings.phoneCountryCode') }}" placeholder="Default Country Code on Phone field (Leave empty if not required)">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="col-lg-3 col-form-label"><strong>Enable MultiLanguage? </strong></label>
                                    <div class="col-lg-9">
                                        <div class="checkbox checkbox-switchery mt-2">
                                            <label>
                                            <input value="true" type="checkbox" class="switchery-primary" @if(config('settings.multiLanguageSelection') == "true") checked="checked" @endif name="multiLanguageSelection">
                                            </label>
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="col-lg-3 col-form-label"><strong>Enable Delivery Guy's Earnings? </strong></label>
                                    <div class="col-lg-9">
                                        <div class="checkbox checkbox-switchery mt-2">
                                            <label>
                                            <input value="true" type="checkbox" class="switchery-primary" @if(config('settings.enableDeliveryGuyEarning') == "true") checked="checked" @endif name="enableDeliveryGuyEarning">
                                            </label>
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="col-lg-3 col-form-label"><strong>Delivery Guy's Earning Form? </strong></label>
                                    <div class="col-lg-9">
                                        <div class="checkbox checkbox-switchery mt-2">
                                            <label>
                                            <select name="deliveryGuyCommissionFrom" class="form-control">
                                                <option value="FULLORDER" @if(config('settings.deliveryGuyCommissionFrom') == "FULLORDER") selected="selected" @endif>Commission from Full Order Value</option>
                                                <option value="DELIVERYCHARGE" @if(config('settings.deliveryGuyCommissionFrom') == "DELIVERYCHARGE") selected="selected" @endif>Commission from Delivery Charge Value</option>
                                            </select>
                                            </label>
                                        </div>
                                    </div>
                                ...
                                <div class="form-group row">
                                    <label class="col-lg-3 col-form-label"><strong>Google Map API Key: </strong> <br> (with HTTP Restriction)</label>
                                    <div class="col-lg-9">
                                        <input type="text" class="form-control form-control-lg" name="googleApiKey"
                                            value="{{ config('settings.googleApiKey') }}" placeholder="Google Map API Key which has HTTP Restrictions">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="col-lg-3 col-form-label"><strong>Google Map API Key: </strong> <br> (with IP Restriction)</label>
                                    <div class="col-lg-9">
                                        <input type="text" class="form-control form-control-lg" name="googleApiKeyIP"
                                            value="{{ config('settings.googleApiKeyIP') }}" placeholder="Google Map API Key which has IP Restrictions">
                                    </div>
                                </div>
                                <hr style="border-top: 3px dashed rgba(103, 58, 183, 0.20);">
                                <div class="form-group row">
                                    <label class="col-lg-3 col-form-label"><strong>Enable Development Mode? </strong></label>
                                    <div class="col-lg-9">
                                        <div class="checkbox checkbox-switchery mt-2">
                                            <label>
                                            <input value="true" type="checkbox" class="switchery-primary" @if(config('settings.enDevMode') == "true") checked="checked" @endif name="enDevMode">
                                            </label>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="tab-pane fade" id="pushNotificationSettings">
                                ...
                                <div class="form-group row">
                                    <label class="col-lg-3 col-form-label"><strong>Firebase Web Push Certificate:</strong></label>
                                    <div class="col-lg-9">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-9">
                                        ...
                                        <span class="help-text text-muted"><a href="https://stackcanyon.com/docs/foodomaa/admin-push-notifications" target="_blank">How to configure Push Notifiactions? </a></span>
                                        <p class="text-danger"><strong>Note: </strong> Legacy server key cannot be used.</p>
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-9">
                                        <textarea rows="10" class="form-control form-control-lg" name="firebaseSDKSnippet" placeholder="Paste your Firebase SDK Snippet Config">{{ config('settings.firebaseSDKSnippet') }}</textarea>
                                        <span class="help-text text-muted">This is to configure Push Notifications for Restaurant Owner <br><a href="https://stackcanyon.com/docs/foodomaa/admin-push-notifications" target="_blank">How to setup Firebase SDK? </a></span>
                                    </div>
                                </div>
                                <br><hr><a href="https://firebase.google.com/" target="_blank" rel="nofollow">Click Here</a> to get your Firebase Credentials. <br>
                            </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-9">
                                        <input type="text" class="form-control form-control-lg" name="razorpayKeyId"
                                            value="{{ config('settings.razorpayKeyId') }}" placeholder="Razorpay Key Id (Leave blank if not using Razorpay)">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-9">
                                        <input type="text" class="form-control form-control-lg" name="razorpayKeySecret"
                                            value="{{ config('settings.razorpayKeySecret') }}" placeholder="Razorpay Secret Key (Leave blank if not using Razorpay)">
                                    </div>
                                </div>
                            </div>
                            <div class="tab-pane fade" id="smsGatewaySettings">
                                ...
                                <div class="form-group row">
                                    <label class="col-lg-3 col-form-label"><strong>OTP Verficiation on Registration</strong></label>
                                    <div class="col-lg-9">
                                        <div class="checkbox checkbox-switchery mt-2">
                                            <label>
                                            <input value="true" type="checkbox" class="switchery-primary" @if(config('settings.enSOV') == "true") checked="checked" @endif name="enSOV">
                                            </label>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-9">
                                        <input type="text" class="form-control form-control-lg" name="twilioAccessToken"
                                            value="{{ config('settings.twilioAccessToken') }}" placeholder="Twilio Access Token">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-9">
                                        <input type="text" class="form-control form-control-lg" name="twilioServiceId"
                                            value="{{ config('settings.twilioServiceId') }}" placeholder="Twilio Service ID">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="tab-pane fade" id="customCSS">
                                ...
                                <p>Below code will affect the styling for the Customer Application & the Delivery Application</p>
                                <div id="css_editor1">{{ config('settings.customCSS') }}</div>
                                <textarea style="display: none" class="form-control" name="customCSS" rows="5" placeholder="Your CSS code goes here...">{{ config('settings.customCSS') }}</textarea>
                            </div>
                            <div class="tab-pane fade" id="fixUpdateIssues">
                                <legend class="font-weight-semibold text-uppercase font-size-sm">
                                    Fix Update Issues
                                </legend>
                                <p>Sometimes after an update, the front-facing app (for customer or delivery) may have some issues.
                                ...
                                @if(Request::secure())
                                <a href="{{ route('admin.fixUpdateIssues') }}" class="btn btn-lg btn-primary">Fix Issues Now</a>
                                @else
                                <a href="#" onclick="return false;" style="opacity: 0.6; cursor: not-allowed;" data-popup="tooltip" title="You need to use https version of URL for admin dashboard to proceed. Example: https://yourdomain.com/public/admin/settings" data-placement="bottom" class="btn btn-lg btn-primary">Fix Issues Now</a>
                                @endif
                            </div>
                        </div>
                    </div>
